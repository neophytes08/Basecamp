    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo base_url('index.php/camp/profile') ?>" > Welcome <?php echo ucwords($user->fname).' '.ucwords($user->lname) ?></a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <?php foreach ($project as $ID) {} ?>
            ...
            <li class="active"><a href="<?php echo base_url('index.php/todo/create_todo_list/'.$ID->project_id);?>"><img src="<?php echo base_url('images/todo_list.png') ?>" atl="upload icon" width="30" height="30"> Add To-do-list</a></li>
          ...
          <div class="col-sm-4">
            <div class="panel panel-primary add-member">
              ...
              <div class="panel-body">
                <div class="new_team">
                <h3><a href="">Make your "To-Do-List" here for your projects</a></h3>
                <p>
                  <h4>This section will create a list of your work to do to your corresponding project.</h4>
                  Start a list for your work for your project. Any member of your team will visible to this projects.
                </p>
                <p>
